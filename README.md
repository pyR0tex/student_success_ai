...
The professor-provided synthetic CSV files are included in the data/ directory so the project can be reproduced using the original supplied dataset.
...
The original provided synthetic datasets remain in data/. The results/ directory contains only derived outputs generated by the project.
